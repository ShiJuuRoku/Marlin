...
#define STRING_CONFIG_H_AUTHOR "(SJR, Ender-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SJR's Ender-5"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.45  // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (Y_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER)
  // #define RIGHT_PROBE_BED_POSITION (Y_BED_SIZE - MIN_PROBE_EDGE)
